...
class User(db.Model):
    ...
    role = db.Column(
        db.Enum("admin", "manager", "mechanic", name="user_role"),
        nullable=False,
        default="mechanic"
    )
    ...
    workshop_id = db.Column(
        db.Integer, db.ForeignKey("workshops.id"), nullable=True
    )
    ...
    def serialize(self):
        return {
            ...
            "first_registration_date":  self.first_registration_date.isoformat()
                                        if self.first_registration_date else None,
...
class Service(db.Model):
    ...
    parts_cost  = db.Column(db.Float, default=0.0, nullable=True)  
    labor_cost  = db.Column(db.Float, default=0.0, nullable=True)  
    labor_hours = db.Column(db.Float, default=0.0, nullable=True)  
    ...
    def serialize(self):
        return {
            ...
            "total_price":  (self.parts_cost or 0) + (self.labor_cost or 0),
